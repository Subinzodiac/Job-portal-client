...
import {FaBarsStaggered, FaRegCircle, FaRegCircleUser, FaXmark} from "react-icons/fa6";
const Navbar = () => {
      ...
      <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <nav className="flex justify-between item-center py-6">
          ...
          <div className="text-base text-primary font-medium space-x-5 hidden lg:block">
                ...
                <Link to="/admin" className="py-1 px-2 border rounded bg-Green text-white ">Admin</Link>
